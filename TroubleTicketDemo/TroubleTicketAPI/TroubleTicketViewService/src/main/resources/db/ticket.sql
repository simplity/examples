...
DROP TABLE RELATEDPARTYREF IF EXISTS;
...
ALTER TABLE NOTE ADD FOREIGN KEY (ticketId) REFERENCES TICKET(id);
ALTER TABLE RELATEDPARTYREF ADD FOREIGN KEY (ticketId) REFERENCES TICKET(id);
ALTER TABLE RELATEDOBJECT ADD FOREIGN KEY (ticketId) REFERENCES TICKET(id);
