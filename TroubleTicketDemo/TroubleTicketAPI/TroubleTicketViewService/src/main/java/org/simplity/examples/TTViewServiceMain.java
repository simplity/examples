...
public class TTViewServiceMain {
	public static Server server;
	public static void main(String[] args) {
		try {
			server = new Server(8092);
			File jarPath = new File(TTViewServiceMain.class.getProtectionDomain().getCodeSource().getLocation().getPath());			
