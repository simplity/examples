...
public class TestContent {
    ...
    public static final String CLIENT_ID = "TTUIMain";
    public static final String CLIENT_SECRET = "TTUIMain";
    public static final String USERNAME = "TTUIMain";
    public static final String PASSWORD = "TTUIMain";
