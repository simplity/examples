...
public class AdminEndpointsTests {
	...
	public void testListTokensByUser() throws Exception {
		ResponseEntity<String> result = serverRunning.getForString("/oauth2/oauth/clients/my-trusted-client/users/marissa/tokens");
	...
	public void testRevokeTokenByUser() throws Exception {
		...
		try {
			...
			ResponseEntity<String> result = serverRunning.getForString("/oauth2/oauth/clients/my-client-with-registered-redirect/users/marissa/tokens", headers);
	...
	public void testClientListsTokensOfUser() throws Exception {
		ResponseEntity<String> result = serverRunning.getForString("/oauth2/oauth/clients/my-client-with-registered-redirect/users/marissa/tokens");
		assertEquals(HttpStatus.OK, result.getStatusCode());
	...
	public void testCannotListTokensOfAnotherUser() throws Exception {
		try {
			serverRunning.getStatusCode("/oauth2/oauth/clients/my-client-with-registered-redirect/users/foo/tokens");
			fail("Should have thrown an exception");
