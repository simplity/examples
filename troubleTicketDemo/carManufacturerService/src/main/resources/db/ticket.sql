...
ALTER TABLE NOTES ADD FOREIGN KEY (ticketId) REFERENCES TICKET(id);
ALTER TABLE RELATEDPARTIES ADD FOREIGN KEY (ticketId) REFERENCES TICKET(id);
ALTER TABLE RELATEDOBJECTS ADD FOREIGN KEY (ticketId) REFERENCES TICKET(id);
